        ...
        for year in range(1950, 2016):
            ...
            if row[y]:
                ...
                print("    " + ("" if first else ",") + "(" + ",".join([
                    ...
                    mysql_int(y),  # year
                    mysql_quote("https://www.conference-board.org/retrievefile.cfm?filename=TED---Output-Labor-and-Labor-Productivity-1950-2015.xlsx&type=subsite"),  # database_url
...
fps = glob.glob("../total-economy-database-data/TED---Output-Labor-and-Labor-Productivity-1950-2015.*.csv")
