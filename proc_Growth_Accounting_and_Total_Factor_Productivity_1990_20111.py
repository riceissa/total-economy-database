        ...
        for region in sorted(row):
            if region and row[region] and region != 'Year':
                ...
                print("    " + ("" if first else ",") + "(" + uniq_join([
                    ...
                    mysql_quote("https://www.conference-board.org/retrievefile.cfm?filename=Growth-Accounting-and-Total-Factor-Productivity-1990-20111.xls&type=subsite"),  # database_url
...
fps = glob.glob("../total-economy-database-data/Growth-Accounting-and-Total-Factor-Productivity-1990-20111.*.csv")
