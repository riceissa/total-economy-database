        ...
        for region in sorted(row):
            if region and row[region] and region != 'Year':
                ...
                print("    " + ("" if first else ",") + "(" + ",".join([
                    ...
                    mysql_quote("https://www.conference-board.org/retrievefile.cfm?filename=Output-Labor-and-Labor-Productivity-1950-2010.xls&type=subsite"),  # database_url
...
fps = glob.glob("../total-economy-database-data/Output-Labor-and-Labor-Productivity-1950-2010.*.csv")
