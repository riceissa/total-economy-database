...
with open("../total-economy-database-data/TED_1_MAY20171_adjusted.csv", newline='') as f:
        ...
        for year in range(1950, 2018):
            ...
            if row[y]:
                ...
                print("    " + ("" if first else ",") + "(" + ",".join([
                    ...
                    mysql_quote("https://www.conference-board.org/retrievefile.cfm?filename=TED_1_MAY20171.xlsx&type=subsite"),  # database_url
