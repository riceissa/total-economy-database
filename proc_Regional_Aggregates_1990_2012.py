        ...
        for region in sorted(row):
            if region and row[region] and region != 'Year':
                ...
                print("    " + ("" if first else ",") + "(" + uniq_join([
                    ...
                    mysql_quote("https://www.conference-board.org/retrievefile.cfm?filename=Regional-Aggregates-1990-2012.xlsx&type=subsite"),  # database_url
...
fps = glob.glob("../total-economy-database-data/Regional-Aggregates-1990-2012.*.csv")
